...
import { aw as generateCspDigest, bk as unescapeHTML, ba as renderTemplate, b0 as removeBase, aO as isRemotePath, d as AstroError, a3 as UnknownContentCollectionError } from './params-and-props_BoTtfwYV.mjs';
import { s as spreadAttributes } from './entrypoint_DjevKima.mjs';
...
class ImmutableDataStore {
  ...
  static async fromModule() {
    try {
      const data = await import('./_astro_data-layer-content_BZGzodIA.mjs');
